        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    thumbnail = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true, comment: "缩略图", collation: "utf8mb4_0900_ai_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    is_top = table.Column<byte>(type: "tinyint unsigned", maxLength: 1, nullable: true, comment: "is top"),
                    status = table.Column<byte>(type: "tinyint unsigned", maxLength: 1, nullable: false, defaultValueSql: "'1'", comment: "status (true: published, false: draft)"),
                    view_count = table.Column<long>(type: "bigint", nullable: false, defaultValueSql: "'0'"),
                    is_comment = table.Column<byte>(type: "tinyint unsigned", maxLength: 1, nullable: false, defaultValueSql: "'1'", comment: "Allow comment"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true, collation: "utf8mb4_0900_ai_ci")
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
